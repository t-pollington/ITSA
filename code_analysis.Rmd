...
# during-pilot Vaishali
duringpilot.se = coef.table[7,4]
duringpilot.lower = duringpilot-1.96*duringpilot.se
duringpilot.upper = duringpilot+1.96*duringpilot.se
duringpilot.lower*100 # 48.2
duringpilot.upper*100 # 50.7
...
mean(popn.time.matrix[1,]) * changeoftrend.coeffs[[9]][7] * changeoftrend.coeffs[[9]][9] # interpreting endemic intercept point estimate on jan 2012 for a low-incidence district at its seasonal maximum (thus sin()=1, exp(A_{END}*1) = and exp(A_{END})). 0.03945743/mo on average for the 33 study districts in high season. As far less than 1/mo, no point calculating what it would be in low season.

mean(popn.time.matrix[1,]) * changeoftrend.coeffs[[9]][7] * changeoftrend.coeffs[[9]][9] * changeoftrend.coeffs[[9]][8] # for a high-incidence district in high season, 1.6 cases/mo
NOW DO IT FOR LOW SEASON
