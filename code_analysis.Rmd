...
# table of coeffs
coef.table = matrix(nrow = 8, ncol = 4, dimnames = list(c("other","V","pilot","end.1","end.HL.11","other*V","other*V*pilot","end.1*end.HL.11"),c("modelmean","modelSE","bstrapmean","bstrapSE")))
coef.vector = NULL
for (i in 1:100) {
...
coef.table[1,4] = sd(exp(other.vector))/sqrt(2000)
coef.table[2,4] = sd(exp(V.vector))/sqrt(2000)
coef.table[3,4] = sd(exp(pilot.vector))/sqrt(2000)
coef.table[4,4] = sd(exp(end.1.vector))/sqrt(2000)
coef.table[5,4] = sd(exp(end.HL.HL.vector))/sqrt(2000)
coef.table[6,4] = sqrt(mean(exp(2*other.vector + 2*V.vector)) - (mean(exp(other.vector+V.vector)))^2)/sqrt(2000)
coef.table[7,4] = sqrt(mean(exp(2*other.vector + 2*V.vector + 2*pilot.vector)) - (mean(exp(other.vector + V.vector + pilot.vector)))^2)/sqrt(2000)
coef.table[8,4] = sqrt(mean(exp(2*end.1.vector + 2*end.HL.HL.vector)) - (mean(exp(end.1.vector + end.HL.HL.vector)))^2)/sqrt(2000)
