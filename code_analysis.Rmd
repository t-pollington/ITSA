...
hist(exp(end.HL.HL.vector)) # non-Normal, has long tail
...
dev.off()
```
Model fit appears reasonably homoskedastic. There is some model weakness in overestimating low case counts, however generally the variance in residuals remains constant across case count magnitude. May indicate that a subdistrict model with few cases may be difficult to fit.
